...
class PostDetectionAlgorithm {
    private static final Comparator<DetectedBox> colCompare = (o1, o2) -> integerCompare(o1.col, o2.col);
    private static final Comparator<DetectedBox> rowCompare = (o1, o2) -> integerCompare(o1.row, o2.row);
